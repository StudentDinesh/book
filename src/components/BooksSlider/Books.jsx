...
const booksData = [
  ...
  { id: 4, img: Book4, title: "The Book Thief", rating: 4.7, author: "Someone" },
  { id: 5, img: Book5, title: "The Women", rating: 4.5, author: "Someone" },
];
...
const Books = () => {
  ...
  return (
    <div className="mt-14 mb-12" id="books">
      <div className="container">
        ...
        <div className="flex justify-center">
          <button
            ...
            onClick={() => navigate("/products")} // Navigate to Product.jsx
          >
            View All Books
          </button>
        </div>
